...
namespace CampaignModule.Service.Product
{
    public class ProductService : IProductService
    {
        ...
        public async Task<string> GetAsync(List<string> commands)
        {
            ...
            return ResponseHelper.GetInstance().GetResponse(Constants.ProductConstant.GetProductMessage, new object[] { product.ProductCode, product.CampaignPrice, product.Stock });
        }
    }
}
